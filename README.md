        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Admins"><a href="#api-Admins">API Methods - Admins</a></li>
                    <li data-group="Admins" data-name="addInventory" class="">
                      <a href="#api-Admins-addInventory">addInventory</a>
                    </li>
                  <li class="nav-header" data-group="Developers"><a href="#api-Developers">API Methods - Developers</a></li>
                    <li data-group="Developers" data-name="searchInventory" class="">
                      <a href="#api-Developers-searchInventory">searchInventory</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>This is a simple API</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Admins">
                  <h1>Admins</h1>
                    <div id="api-Admins-addInventory">
                      <article id="api-Admins-addInventory-0" data-group="User" data-name="addInventory" data-version="0">
                        <div class="pull-left">
                          <h1>addInventory</h1>
                          <p>adds an inventory item</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Adds an item to the system</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/inventory</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Admins-addInventory-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Admins-addInventory-0-java">Java</a></li>
                          <li class=""><a href="#examples-Admins-addInventory-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Admins-addInventory-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Admins-addInventory-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Admins-addInventory-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Admins-addInventory-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Admins-addInventory-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Admins-addInventory-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Admins-addInventory-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Admins-addInventory-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Admins-addInventory-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://virtserver.swaggerhub.com/MathLanca/PersonAPI/1.0.0/inventory"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Admins-addInventory-0-java">
...
public class AdminsApiExample {
    ...
    public static void main(String[] args) {
        ...
        InventoryItem inventoryItem = ; // InventoryItem | Inventory item to add
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Admins-addInventory-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.AdminsApi;
...
public class AdminsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Admins-addInventory-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Admins-addInventory-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">InventoryItem *inventoryItem = ; // Inventory item to add (optional)

AdminsApi *apiInstance = [[AdminsApi alloc] init];

// adds an inventory item
[apiInstance addInventoryWith:inventoryItem
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Admins-addInventory-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var SimpleInventoryApi = require('simple_inventory_api');
...
api.addInventory(opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Admins-addInventory-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Admins-addInventory-0-csharp">
...
namespace Example
{
    public class addInventoryExample
    {
        public void main()
        {
            ...
            var inventoryItem = new InventoryItem(); // InventoryItem | Inventory item to add (optional) 
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling AdminsApi.addInventory: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Admins-addInventory-0-php">
...
try {
    $api_instance->addInventory($inventoryItem);
} catch (Exception $e) {
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Admins-addInventory-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::AdminsApi;

my $api_instance = WWW::SwaggerClient::AdminsApi->new();
my $inventoryItem = WWW::SwaggerClient::Object::InventoryItem->new(); # InventoryItem | Inventory item to add

eval { 
    $api_instance->addInventory(inventoryItem => $inventoryItem);
};
if ($@) {
    warn "Exception when calling AdminsApi->addInventory: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Admins-addInventory-0-python">
...
try: 
    # adds an inventory item
    api_instance.add_inventory(inventoryItem=inventoryItem)
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">inventoryItem </td>
<td>
...
$(document).ready(function() {
  ...
  var result = $('#d2e199_addInventory_inventoryItem');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_addInventory_inventoryItem"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <h3> Status: 400 - invalid input, object invalid </h3>
                            ...
                            <h3> Status: 409 - an existing item already exists </h3>
                ...
                <section id="api-Developers">
                  <h1>Developers</h1>
                    <div id="api-Developers-searchInventory">
                      <article id="api-Developers-searchInventory-0" data-group="User" data-name="searchInventory" data-version="0">
                        <div class="pull-left">
                          <h1>searchInventory</h1>
                          <p>searches inventory</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">By passing in the appropriate options, you can search for
available inventory in the system
</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/inventory</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Developers-searchInventory-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Developers-searchInventory-0-java">Java</a></li>
                          <li class=""><a href="#examples-Developers-searchInventory-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Developers-searchInventory-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Developers-searchInventory-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Developers-searchInventory-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Developers-searchInventory-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Developers-searchInventory-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Developers-searchInventory-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Developers-searchInventory-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Developers-searchInventory-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Developers-searchInventory-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://virtserver.swaggerhub.com/MathLanca/PersonAPI/1.0.0/inventory?searchString=&skip=&limit="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Developers-searchInventory-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Developers-searchInventory-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.DevelopersApi;
...
public class DevelopersApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Developers-searchInventory-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Developers-searchInventory-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *searchString = searchString_example; // pass an optional search string for looking up inventory (optional)
...
[apiInstance searchInventoryWith:searchString
    ...
    limit:limit
              completionHandler: ^(array[InventoryItem] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Developers-searchInventory-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var SimpleInventoryApi = require('simple_inventory_api');

var api = new SimpleInventoryApi.DevelopersApi()
...
api.searchInventory(opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Developers-searchInventory-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Developers-searchInventory-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling DevelopersApi.searchInventory: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Developers-searchInventory-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Developers-searchInventory-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
...
if ($@) {
    warn "Exception when calling DevelopersApi->searchInventory: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Developers-searchInventory-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">searchString</td>
<td>


    <div id="d2e199_searchInventory_searchString">
                ...
                <span class="type">
                    ...
                    <div class="inner description">
                        pass an optional search string for looking up inventory
                                ...
                                <tr><td style="width:150px;">skip</td>
<td>


    <div id="d2e199_searchInventory_skip">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_searchInventory_limit">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
                    ...
                    <div class="inner description">
                        maximum number of records to return
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - search results matching criteria </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-searchInventory-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-searchInventory-200-schema">
                                  <div id='responses-searchInventory-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  ...
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/InventoryItem"
                                        ...
                                        $('#responses-searchInventory-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-searchInventory-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-searchInventory-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - bad input parameter </h3>
